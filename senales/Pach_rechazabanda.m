...
H=( s.^2+1/(L*C) ) ./( s.^2+s/(R*C)+1/(L*C) );		%rechanza banda
...
C=0.05;  
L=0.5;
RF=( w.^2+1/(L*C) ) ./( w.^2+w/(R*C)+1/(L*C) );		%rechaza banda
ejeome=imag(w);
plot(ejeome,abs(RF),'b');             %frecuencia 1
xlabel('eje real');
ylabel('eje imaginario')
title('Plano de LaPlace: Rechaza Banda R=1')
...
xlabel('eje real');
ylabel('eje imaginario')
title('Plano de LaPlace: Rechaza Banda R=0.3')
...
xlabel('eje real');
ylabel('eje imaginario')
title('Plano de LaPlace: Rechaza Banda R=0.6')
...
xlabel('eje real');
ylabel('eje imaginario')
title('Plano de LaPlace: Rechaza Banda R=0.8')